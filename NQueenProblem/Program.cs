...
class Program
{
    ...
    static bool solveNQUtility(int[,] board, int col)
    {
    ...
    /* This function solves the N Queen problem using Backtracking. It mainly uses solveNQUtility() to solve the problem. 
